...
trip2 = Trip.create(date: (Date.today + 2), location: 'Sigmund Stern Recreation Grove', time: (Time.now.utc).strftime("%I:%M %p"))
...
trip6 = Trip.create(date: (Date.today + 6), location: 'Sigmund Stern Recreation Grove', time: (Time.now.utc).strftime("%I:%M %p"))
trip7 = Trip.create(date: (Date.today + 8), location: "Marshall's Beach", time: (Time.now.utc).strftime("%I:%M %p"))
trip8 = Trip.create(date: (Date.today + 9), location: "Lands End", time: (Time.now.utc).strftime("%I:%M %p"))
